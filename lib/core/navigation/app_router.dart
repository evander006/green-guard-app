    ...
    return GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          ...
          name: 'plantCriteria',
          builder: (context, state) => const PlantCriteriaPage(),
        ),
        
        ShellRoute(
          builder: (context, state, child) => RootShell(child: child),
          routes: [
            GoRoute(path: AppRoutes.home, name: 'rootHome', pageBuilder: (context, state) => const NoTransitionPage(child: HomePage())),
            GoRoute(path: AppRoutes.calendar, name: 'rootCalendar', pageBuilder: (context, state) => const NoTransitionPage(child: CalendarPage())),
            GoRoute(path: AppRoutes.scanner, name: 'rootScanner', pageBuilder: (context, state) => const NoTransitionPage(child: ScannerPage())),
            GoRoute(path: AppRoutes.plants, name: 'rootPlants', pageBuilder: (context, state) => const NoTransitionPage(child: PlantsPage())),
            GoRoute(path: AppRoutes.profile, name: 'rootProfile', pageBuilder: (context, state) => const NoTransitionPage(child: ProfilePage())),
          ],
        ),
      ],
    );
